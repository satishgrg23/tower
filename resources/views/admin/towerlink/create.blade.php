            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-bars"></i>Add Tower Link</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <label class="float-left">Add Tower Link</label>
                        </header>
                        <!-- Div to display success or error message -->
                        <div class="panel-body">
                            <!-- Form starts -->
                            <form action="/admin/towerlink" method="POST">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label for="tower_link">Tower Link</label>
                                    <div class="input-div">
                                        <input type="text" name="tower_link" id="tower_link" class="form-control" required>
                                    </div>
                                </div>
