                ...
                <div class="col-md-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <a href="{{ URL::to('admin/exportReport') }}" class="btn btn-success" style="float: right;">Export Report in Excel</a>
                            <!-- <a href="{{ URL::to('') }}" class="btn btn-success" style="float: right; margin-right: 20px;">Export images</a> -->
                            <div class="dropdown" style="float:right; margin-right: 20px;">
                                <a id="dLabel" role="button" data-toggle="dropdown" class="btn btn-primary" data-target="#" href="#">
                                    Export Images <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                    <li><a href="{{ URL::to('admin/exportPhotos') }}">All images</a></li>
                                    <li><a href="{{ URL::to('admin/showDirectory') }}">Specific images/folder</a></li>
                                </ul>
                            </div>
                        </header>
